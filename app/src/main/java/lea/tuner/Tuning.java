...
public class Tuning {
	...
	private static TuningType [] tuningTypes = new TuningType[]{
		new TuningType("Guitar 432Hz",
				new double[]{80.91, 108.00, 144.16, 192.43, 242.45, 323.63},
				new String[]{"E","A","D","G","B","E"}) ,
            new TuningType("Guitar Standard 440Hz",
                    new double[]{82.41, 110.00, 146.83, 196.00, 246.94, 329.63},
                    new String[]{"E","A","D","G","B","E"}) ,
		new TuningType("Ukelele",
				new double[]{77.78, 256.87, 138.59, 185.00, 233.08, 311.13},
				new String[]{"G","C","E","A","X","X"}) ,
